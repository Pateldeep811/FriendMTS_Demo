...
//********* ScreenShot Methods ****************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "src/main/java/com/friendmts/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "src/main/java/com/friendmts/screenshots/" + screenshotName + dateName + ".png";
    ...
    public void acceptCookies() throws InterruptedException {
        Thread.sleep(500);
        WebElement acceptCookies = driver.findElement(By.id("cookienote-continue-button"));
        acceptCookies.click();
    }
